function Search() {
  return (<div className="bg-[#a6a6a6]/[0.03] rounded-[20px] p-2 flex flex-row justify-between items-center gap-2">
    <div className="flex flex-row justify-between items-center gap-2 w-full">
      <span className="flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} className="size-5 text-white/40 p-0"><path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" /></svg>
      </span>
    ...
    <button className="text-green-600/60 h-[35px] w-[35px] rounded-[20px] flex justify-center items-center cursor-pointer  bg-[#a6a6a6]/[0.025] hover:bg-[#a6a6a6]/[0.04] active:bg-[#a6a6a6]/[0.03]  hover:text-green-600/90">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className="size-5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
    </button>
  </div>);
}

function ChatList() {
  return (<div className="flex gap-2 flex-col h-full">
...
function CurrentUser() {
  return (<div className="flex justify-self-end flex-row gap-[10px] justify-between items-center p-2 pr-[14px] rounded-[20px] bg-[#a6a6a6]/[0.025] ">
    {/* profile */}
    <div className="flex flex-row gap-[10px]">
      {/* pic */}
