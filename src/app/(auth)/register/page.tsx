  ...
  return (
    <div className="h-screen w-full flex items-center justify-center">
      <div className="bg-[#a6a6a6]/[0.025] p-10 flex flex-col justify-center items-center gap-8 rounded-[20px] w-96">
        <h1 className="text-white font-bold text-3xl w-full text-center">
          Register
        </h1>
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <button className="bg-[#a6a6a6]/[0.025] placeholder-[#3C3C43]/[0.6] rounded-[20px] px-4 py-2 text-white/95 border-transparent outline-none leading-5 hover:bg-[#a6a6a6]/[0.04] active:bg-[#a6a6a6]/[0.03]">Register</button>
        </div>

        <span className="text-white/60 font-light">Already have an account? <Link href="/login" className="font-normal underline">Login</Link></span>
      </div>
    </div>
  );
}
